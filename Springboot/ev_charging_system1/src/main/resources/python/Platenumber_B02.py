...
CAMERA_NAME = os.getenv("EV_CAMERA_NAME", "B02")
VIDEO_FILE  = os.getenv("EV_VIDEO_FILE", "car105.mp4")
STATION_PK  = int(os.getenv("EV_STATION_PK", "4"))
FLASK_PORT  = int(os.getenv("EV_FLASK_PORT", "5004"))
